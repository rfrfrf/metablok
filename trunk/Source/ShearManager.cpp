...
// ---------------------------------------------------------
Shear::ShearManager::ShearManager( )
{
	currentState = NULL;
}
//
...
// ---------------------------------------------------------
void Shear::ShearManager::startUp( HINSTANCE instHandle )
{
...
// ---------------------------------------------------------
void Shear::ShearManager::shutDown( )
{
...
// is true.
//----------------------------------------------------------
void Shear::ShearManager::onRenderFrame( DirectX::Camera* camera )
{
...
// ---------------------------------------------------------
bool Shear::ShearManager::onDeviceAcceptable( D3DCAPS9* pCaps, D3DFORMAT AdapterFormat, D3DFORMAT BackBufferFormat ) 
{
...
//--------------------------------------------------------------------------------------
void Shear::ShearManager::onMessageEvent( UINT message, WPARAM wParam, LPARAM lParam )
{
...
//--------------------------------------------------------------------------------------
void Shear::ShearManager::loadDefaultWindowStyle( )
{
